...
<html lang="en">
  ...
  <body >
	<div class="container" id="container" style="display:block;padding-top:30px;">
		...
		<div class="col-lg-12" role="navigation" style="margin-bottom: 0;background-color:#f8f8f8;border-color: #e7e7e7;" >
			...
			<div class="col-lg-12">
				...
				<div class="col-lg-12" id="lockedFilesTableDiv" style="display : none">
					<table id="lockedFilesTable" class="table table-striped table-bordered" cellspacing="0" width="100%" style="border:1px solid #7CA5AF;">
						<thead>
							<tr>
								<th>File Name </th>
								<th>Locked By</th>
	...
	<script src="resources/js/unlockFiles.js"></script>
