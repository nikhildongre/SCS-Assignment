			...
			<div class="row" style="margin-top:10px;">
				...
				<div class="col-lg-12">
					<div class="form-group" style="padding-top:10px;">
					  Please select File Version to Rollback
					</div>
				
					<!-- <select  class="col-lg-9 selectpicker" data-live-search="true" data-live-search-style="begins" title="Select version to Rollback" style="width:300px;">
						<option>URL 1</option>
						<option>URL 2</option>
						<option>URL 3</option>
						<option>URl 4</option>
					  ...
					  <select label="Party List" array="Parties" name="Party List">
                         <c:forEach var="party" items="${versions}">
                             <option value="${party}">
                             <c:out value="${party}"/>
                             </option>
                         </c:forEach>
					  ...
					  <div class="col-lg-12 " style="padding-top: 40px;">
						<div class="col-lg-6">
							<button type="submit" tabindex='11' id="red"
								...
								style="margin-right: -30px;">Rollback</button>
						</div>
						<div class="col-lg-6">
